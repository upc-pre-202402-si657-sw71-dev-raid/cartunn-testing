...
Scenario: Solicitud de cambio de contraseña
    ...
    Entonces se envía un <mensaje de recuperacion> de contraseña a su dirección de correo electrónico
...
| Ingresa este código para recuperar tu contraseña: 123456 |
...
Scenario: Solicitud de cambio de contraseña con correo inválido
    ...
    Cuando el usuario ingrese un <correo electronico invalido>
