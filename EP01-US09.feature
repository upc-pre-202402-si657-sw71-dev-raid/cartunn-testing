Feature: Sección Footer
    ...
    Escenario 1: Redirección a nuestra red social
    Dado que el visitante se encuentra en la sección footer
    Cuando el visitante da click en cualquiera de los íconos de las redes sociales
    Entonces el visitante será redirigido a la cuenta de la empresa en la red social seleccionada

    Escenario 2: Redirección a una cuenta no disponible
    Dado que el visitante se encuentra en la sección footer
    Cuando el visitante da click en cualquiera de los íconos de las redes sociales
